...
class Data {
        ...
        if ( $query->have_posts() ) {
            while ( $query->have_posts() ) {
                ...
                if ( ! isset( $data[ $think_tank_slug ] ) ) {
                    $think_tank_post_id = $this->get_post_from_term( $think_tank_slug, 'think_tank' );
                    ...
                    $data[ $think_tank_slug ] = array(
                        ...
                        'donor_types'          => array(),
                        'transparency_score'   => $this->get_transparency_score_from_slug( $think_tank_slug ),
    ...
    public function get_donor_archive_data( $donation_year = '', $donor_type = '', $search = '' ): array {
        ...
        $data = array_reduce($donor_data, function( $carry, $item ) {
    ...
    public function get_single_think_tank_data( $think_tank = '', $donation_year = '', $donor_type = '' ): array {
        ...
        $data = array_reduce($raw_data, function( $carry, $item ) {
            $donor_slug = $item['donor_slug'];
